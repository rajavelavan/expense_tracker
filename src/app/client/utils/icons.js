...
export const tv = <i className="fa-solid fa-circle-tv"></i>
export const circle = <i className="fa-solid fa-circle-dot"></i>
export const rightArrow = <i class="fa-solid fa-angles-right"/>
export const leftArrow = <i class="fa-solid fa-angles-left"/>